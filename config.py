...
def get_params():
    ...
    parser.add_argument("--bi", type=int, default=1, choices=[0, 1])
    parser.add_argument("--use_crf", type=int, default=1, choices=[0, 1])
    parser.add_argument("--atten_flag", type=int, default=1,  choices=[0, 1])
