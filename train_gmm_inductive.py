...
from config_inductive import get_params
from nni.utils import merge_parameter
from model.gmm import GMM
from utils_gq.data_loader_inductive import MyDataset, padding
from torch.utils.data import DataLoader
from graph_data_inductive import GraphData
...
def main(args):
    ...
    for e in range(args['epochs']):
        ...
        if least_loss > train_avg_loss:
            least_loss = train_avg_loss
