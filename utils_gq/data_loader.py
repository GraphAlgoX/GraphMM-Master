...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        return self.traces_ls[index], self.roads_ls[index], self.traces_gps_ls[index]
...
def padding(batch):
    ...
    f = torch.LongTensor
    return f(x), f(y), torch.FloatTensor(z), trace_lens, road_lens
